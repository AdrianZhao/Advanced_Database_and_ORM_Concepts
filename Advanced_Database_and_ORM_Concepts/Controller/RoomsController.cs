...
namespace Advanced_Database_and_ORM_Concepts.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public RoomsController(AdvancedDatabaseAndORMConceptsLab04Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Rooms != null ? 
                          ...
                          Problem("Entity set 'AdvancedDatabaseAndORMConceptsLab04Context.Rooms'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdvancedDatabaseAndORMConceptsLab04Context.Rooms'  is null.");
            }
            var room = await _context.Rooms.FindAsync(id);
            if (room != null)
            {
