...
namespace Advanced_Database_and_ORM_Concepts.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(Advanced_Database_and_ORM_ConceptsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Course != null ? 
                          ...
                          Problem("Entity set 'Advanced_Database_and_ORM_ConceptsContext.Course'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Advanced_Database_and_ORM_ConceptsContext.Course'  is null.");
            }
            var course = await _context.Course.FindAsync(id);
            if (course != null)
            {
